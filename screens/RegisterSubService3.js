...
const RegisterSubService3 = (props) => {
			...
			<ScrollView style={{ backgroundColor: "white" }}>
				<View style={styles.container}>
					<Image
						...
						style={styles.image}
					/>
					<Text style={styles.textTitle}>Now, let’s talk about the things you want to steer clear of.
					</Text>
                    ...
                    1. Providing any misleading or inaccurate information about your identity.
					</Text>

					<Text style={styles.littleTitle}>
					2. Opening duplicate accounts. Remember, you can always create more Gigs.
					</Text>
					...
					<Text style={styles.littleTitle}>
						5. To keep our community secure for everyone, we may ask you to verify
						your ID.
					</Text>
