    ...
    return (
        <SafeAreaView style={{ backgroundColor: COLORS.white, flex: 1 }}>
            ...
            <View
                ...
                <TouchableWithoutFeedback onPress={() => settimeSlot("Morning")}>
                    <View
                        ...
                        <RadioButton
                            value="Morning"
                            status={timeSlot === "Morning" ? "checked" : "unchecked"}
                ...
                <TouchableWithoutFeedback onPress={() => settimeSlot("Evening")}>
                    <View
                        ...
                        <RadioButton
                            value="Evening"
                            status={timeSlot === "Evening" ? "checked" : "unchecked"}
            ...
            <Text style={styles.extraText}>
                Service man will contact you before the start of your booking to confirm exact
                timings.
            </Text>
            <TouchableOpacity
                ...
                <Text style={styles.buttontext}>Find Available Professionals</Text>
            </TouchableOpacity>
        </SafeAreaView>
    );
};
