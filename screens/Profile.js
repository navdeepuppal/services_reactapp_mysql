        ...
        <SafeAreaView style={{ backgroundColor: "#EDF6FD" }}>
                    ...
                    <View>
                        ...
                        <View
                            ...
                            <View
                                ...
                                <TouchableOpacity
                                    onPress={() => {
                                        navigation.navigate("Wallet"), setVisible(false);
                                    }}>
                                    <View
                                        style={{
                                            alignSelf: "center",
                            ...
                            <View style={styles.modalView}>
                                ...
                                <View
                                    ...
                                    <Text
                                        ...
                                        Terms & Conditions{" \n \n"}
                                        Open Sqera T&C Website Page here
                                    </Text>
                                </View>
                            </View>
                        </Modal>
                            ...
                            <View style={styles.modalView}>
                                ...
                                <View
                                    ...
                                    <Text
                                        ...
                                        {" "}
                                        Privacy Policy{" \n \n"}
                                        Open Sqera Privacy Policy Website Page here
                                    </Text>
                                </View>
                            </View>
                        </Modal>
            ...
            <View
                ...
                <TouchableOpacity
                    ...
                    <Text style={styles.textStyle1}>Broadcast your skills or service!</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
