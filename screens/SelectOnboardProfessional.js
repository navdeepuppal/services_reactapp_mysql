        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ justifyContent: "center", alignItems: "center" }}>
                <Text style={styles.subTitle}>
                    Broadcast your skill/service to the world and earn money{" "}
                </Text>
                ...
                <TouchableOpacity
                    ...
                    <View style={{ flexDirection: "column" }}>
                        ...
                        <Text style={styles.littleTitle}>
                            I'm a Electrician, Building Constructor, Appliance Repairer, Seller,
                            Barber, Carpenter, Cleaner and many more related to same..
                        </Text>
                    </View>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                    ...
                    <View style={{ flexDirection: "column" }}>
                        ...
                        <Text style={styles.littleTitle}>
                            I'm a Coder/ Software Engineer/ Consultant/ Social Media Manager/
                            Marketing Specialist / any other..
                        </Text>
                    </View>
                </TouchableOpacity>
            </View>
